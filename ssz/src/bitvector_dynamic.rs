//! Provides `Bitfield<Dynamic>` (BitVectorDynamic): a runtime-length bitvector with no marker bit.
/// This type is useful for encoding and decoding bitvectors that have a runtime-length.
use crate::{
    bitfield::{Bitfield, BitfieldBehaviour, bytes_for_bit_len, SMALLVEC_LEN, Error},
